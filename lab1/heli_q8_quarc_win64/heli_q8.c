...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    rtb_Sum_k = heli_q8_P.elevationref_Value - heli_q8_B.Sum;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Sum: '<S5>/Sum'
     */
    heli_q8_B.K_pp = (heli_q8_P.Gain_Gain * heli_q8_B.Joystick_gain_x -
                      heli_q8_B.PitchCounttorad) * heli_q8_P.K_pp;
  }
   ...
   *  Gain: '<S5>/Gain'
   */
  rtb_Backgain = heli_q8_B.K_pp - heli_q8_P.K_pd * heli_q8_B.PitchTransferFcn;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S6>/K_ei' */
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (316286201U);
  heli_q8_M->Sizes.checksums[1] = (3321175406U);
  heli_q8_M->Sizes.checksums[2] = (2828569933U);
  heli_q8_M->Sizes.checksums[3] = (3256868850U);
