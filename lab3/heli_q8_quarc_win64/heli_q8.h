...
struct P_heli_q8_T_ {
  real_T A2[25];                       /* Variable: A2
                                        * Referenced by: '<S8>/A'
                                        */
  real_T B2[10];                       /* Variable: B2
                                        * Referenced by: '<S8>/B'
                                        */
