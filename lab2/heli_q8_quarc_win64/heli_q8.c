 ...
 * C source code generated on : Fri Oct 02 14:34:47 2020
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    heli_q8_B.Gain1[0] += heli_q8_P.F[0] * rtb_Gain;
    heli_q8_B.Gain1[0] += heli_q8_P.F[2] * heli_q8_B.Joystick_gain_y;
    heli_q8_B.Gain1[1] = 0.0;
    heli_q8_B.Gain1[1] += heli_q8_P.F[1] * rtb_Gain;
  ...
  /* SignalConversion: '<Root>/TmpSignal ConversionAtGain2Inport1' incorporates:
  ...
  for (i = 0; i < 2; i++) {
    ...
    rtb_Sum1[i] = heli_q8_B.Gain1[i] - u0;
  }

  /* End of Sum: '<Root>/Sum1' */
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Constant: '<Root>/V_s,0' */
    heli_q8_B.V_s0 = heli_q8_P.V_s0_Value;
  }

  /* Sum: '<Root>/Sum' */
  heli_q8_B.Sum = rtb_Sum1[0] + heli_q8_B.V_s0;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Sum: '<S2>/Sum' incorporates:
     *  Constant: '<S2>/Constant'
     */
    heli_q8_B.Sum_n = heli_q8_B.ElevationCounttorad - heli_q8_P.Constant_Value;
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (heli_q8_B.Sum - rtb_Sum1[1]) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (heli_q8_B.Sum + rtb_Sum1[1]) * heli_q8_P.Backgain_Gain;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Sum: '<S4>/Sum3' */
    heli_q8_B.Sum3 = heli_q8_B.PitchCounttorad - rtb_Gain;
  }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (534989985U);
  heli_q8_M->Sizes.checksums[1] = (1032604918U);
  heli_q8_M->Sizes.checksums[2] = (3323951419U);
  heli_q8_M->Sizes.checksums[3] = (3198455222U);
